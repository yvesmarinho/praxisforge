...
| raiz-do-projeto (sem spec) | CLI resolve `schemas/`, `skills/`, `src/data/sources/` e o registro antigo pela raiz do projeto (marcador `pyproject.toml`, override `PRAXISFORGE_ROOT`) — roda de qualquer subpasta | [ADR 0010](decisions/0010-raiz-do-projeto-por-marcador.md) |
| 009-acervo-library | Acervo `library/` com seis tipos (skills, commands, agents, hooks, rules, references), validação por tipo, `library/INDEX.md` determinístico, publicação só em projetos, fontes "só ideias" (`source-schema-v3`) e migração de `skills/` | [spec](../specs/009-acervo-library/spec.md) · [plan](../specs/009-acervo-library/plan.md) · [ADR 0011](decisions/0011-acervo-library.md) · [ADR 0012](decisions/0012-fontes-so-ideias.md) · [guia](guides/criar-publicar-acervo.md) |
| 010-inventario-curadoria | Inventário determinístico de curadoria por pasta (sem LLM): classificação por convenções fora do repositório, exclusões com motivo, manifesto e estado por alias com lock e gravação atômica, reinventário incremental por hash, `curation inventory|status` | [spec](../specs/010-inventario-curadoria/spec.md) · [plan](../specs/010-inventario-curadoria/plan.md) · [ADR 0013](decisions/0013-inventario-de-curadoria.md) · [guia](guides/inventariar-curadoria.md) |
