...
|-------------|-------|
| **Nome** | praxisforge |
| **Descrição** | Curadoria e engenharia de agentes para Claude — pesquisa, síntese e refino contínuo de conhecimento aplicado ao desenvolvimento de agentic AI. |
| **Domínio** | programming |
| **Linguagem** | python |
| **Repositório** | git@github.com:yvesmarinho/praxisforge.git |
...
- Commit inicial: `chore: scaffold inicial do projeto praxisforge`
- Tag: `scaffold-v1.0.0` (marca versão do template)
- Branch: `master`
- Remote: `origin` → git@github.com:yvesmarinho/praxisforge.git
...
*Gerado automaticamente em 2026-09-18T18:56:11Z*
