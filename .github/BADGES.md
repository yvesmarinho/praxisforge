...
```markdown
![Git Validation](https://github.com/git@github.com:yvesmarinho/praxisforge.git/workflows/Git%20Validation/badge.svg)
```
...
```markdown
![CI](https://github.com/git@github.com:yvesmarinho/praxisforge.git/workflows/CI/badge.svg)
![CD](https://github.com/git@github.com:yvesmarinho/praxisforge.git/workflows/CD/badge.svg)
```
